...
describe('ErrorCodes — catálogo', () => {
  ...
  test('codes críticos existen', () => {
    const required = [
      ...
      'BOOKING_CANNOT_LEAVE', 'CHECKOUT_NOT_AVAILABLE', 'CHECKOUT_PROVIDER_NOT_CONFIGURED',
      'CHECKOUT_ACCOUNT_NOT_FOUND', 'CHECKOUT_NO_PENDING_BALANCE', 'CHECKOUT_FORBIDDEN',
      'CHECKOUT_ALREADY_PAID', 'CHECKOUT_ATTEMPT_ALREADY_EXISTS', 'CHECKOUT_AMOUNT_CHANGED',
      'PAYMENT_PROVIDER_NOT_CONFIGURED', 'PAYMENT_PROVIDER_AUTH_FAILED',
      'PAYMENT_PROVIDER_CALLBACK_INVALID', 'PAYMENT_PROVIDER_STATE_INVALID',
      'ONLINE_PAYMENT_ATTEMPT_NOT_FOUND', 'ONLINE_PAYMENT_WEBHOOK_INVALID',
      'ONLINE_PAYMENT_ALREADY_PROCESSED',
